...
@section('breadcrumb')
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Aturan penggunaan</li>
  </ol>
@endsection
    ...
    <div class="row">
      <div class="col-12">
        ...
        <div class="section">
            ...
            <ul>
            <li>Bi-Mobile sebagai sarana penunjang bisnis berusaha menyediakan berbagai fitur dan layanan untuk menjamin keamanan dan kemudahan transaksi antar nasabahnya.</li>
            ...
            <li>Biaya administrasi dari setiap transaksi pembayaran maupun jual beli, bisa ditentukan secara internal oleh manajemen BMT maupun kesepakatan bersama Nasabah Pelapak.</li>
      ...
      <div class="section">
        ...
        <ol>
          <li>Nasabah Pelapak bertanggungjawab secara penuh atas risiko yang timbul di kemudian hari terkait dengan informasi yang dibuatnya. Namun tidak terbatas pada hal-hal yang berkaitan dengan hak cipta, merek, desain industry, desain tata letak sirkuit, hak paten dan/ atau izin lain yang telah ditetapkan atas suatu produk menurut hukum yang berlaku di Indonesia.</li>
          <li>Nasabah Pelapak hanya diperbolehkan menjual barang-barang yang tidak tercantum di daftar “Barang Terlarang”.</li>
      ...
      <div class="section">
        ...
        <ol>
          <li>Demi keamananan dan kenyamanan para Pengguna, setiap transaksi jual beli di Bi-Mobile diwajibkan untuk menggunakan Bi-Mobile Payment System. Untuk informasi mengenai penggunaan Bi-Mobile Payment System dapat dipelajari di Panduan Bi-Mobile.</li>
          ...
          <li>Jika Nasabah Pembeli tidak memberikan konfirmasi penerimaan barang dalam waktu 2x24 jam sejak status resi pengiriman dinyatakan telah diterima oleh sistem tracking jasa pengiriman, MT akan mentransfer dana langsung ke rekening Nasabah Pelapak tanpa memberikan konfirmasi ke Nasabah Pembeli.</li>
          ...
          <li>Nasabah Pembeli wajib mengirimkan barang ke Nasabah Pelapak dan menginformasikan nomor resi ke BMT jika ada kesepakatan retur dengan Nasabah Pelapak.</li>
          <li>BMT hanya memantau retur sampai barang diterima kembali oleh Nasabah Pelapak.</li>
          <li>BMT berhak melakukan refund dana ke Nasabah Pembeli jika barang retur telah sampai di kantor BMT dan berdasarkan pengecekan sesuai dengan yang dikeluhkan Nasabah Pembeli.</li>
          <li>BMT atas kebijakannya sendiri dapat melakukan penahanan atau pembekuan rekening Nasabah untuk melakukan perlindungan terhadap segel risiko dan kerugian yang timbul, jika BMT menyimpulkan bahwa tindakan pengguna, baik Nasabah Pelapak maupun Nasabah Pembeli terindikasi melakukan kecurangan-kecurangan atau penyalahgunaan dalam bertransaksi dan/ atau pelanggaran terhadap Aturan Penggunaan Bi-Mobile dan jika akun Pengguna diduga atau terindikasi telah diakses oleh pihak lain.</li>
        </ol>
      </div>
      ...
      <div class="section">
        ...
        <ol>
          ...
          <li>Senjata api, perlengkapan senjata api, replika senjata api, airsoft gun, air gun, dan peluru atau sejenis peluru, senjata tajam, serta jenis senjata lainnya.</li>
          ...
          <li>Barang curian.</li>
          <li>Barang mistis (contoh : susuk, jenglot, dll).</li>
          ...
          <li>Barang yang mengandung unsur pornografi seperti sex toys, alat untuk memperbesar organ vital, maupun barang asusila lainnya.</li>
          ...
          <li>Barang-barang yang dilarang untuk diperjualbelikan secara bebas berdasarkan hukum yang berlaku di Indonesia.</li>
        </ol>
      </div>

      <div class="section">
        <h2 class="mb-4">Sanksi</h2>
        <p>Segala tindakan yang melanggar peraturan di BMT Moblie akan dikenakan sanksi berupa:</p>
        <ol>
          <li>Nasabah Pelapak mendapatkan feedback negatif apabila tidak mengirimkan barang dalam batas waktu pengiriman sejak pembayaran (2 x 24 jam kerja untuk biaya pengiriman kilat).</li>
