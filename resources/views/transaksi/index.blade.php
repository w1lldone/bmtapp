...
@section('content')
	...
	<div class="row">
		...
		<ul class="nav nav-tabs" background="orange" style="padding-right: 0;">
		  <li role="presentation" class="active"><a onclick="loading()" href="/transaksi">Siap Bayar</a></li>
		...
		<div class="card card-plain" style="margin-bottom: 5px">
			<div class="card-header" data-background-color="orange">
				<h4 class="title">Transaksi Siap Dibayar</h4>
									...
									<div class="row">
										...
										<div class="col-md-4 col-xs-6">
											<div id="filter" class="form-group">
												...
												<select name="filter" class="form-control">
												  <option value="semua-s">semua</option>		
												  <option value="butuh tindakan">butuh tindakan</option>		
										...
										<div class="col-md-5 col-xs-12">
											<div class="form-group">
										    	...
										    	<a href="/transaksi" class="btn btn-warning"><i class="material-icons">refresh</i></a>
