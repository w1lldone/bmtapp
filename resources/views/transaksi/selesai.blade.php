...
@section('breadcrumb')
	<ol class="breadcrumb">
		...
		<li><a href="/transaksi/diproses">Diproses</a></li>
		<li>Selesai</li>
	</ol>
@endsection
...
@section('content')
	...
	<div class="row">
		...
		<ul class="nav nav-tabs" background="blue" style="padding-right: 0;">
		  ...
		  <li role="presentation" ><a onclick="loading()" href="/transaksi/diproses">Diproses</a></li>
		  <li role="presentation" class="active"><a onclick="loading()" href="/transaksi/selesai">Selesai</a></li>
		  {{-- SETTINGS --}}
		...
		<div class="card card-plain" style="margin-bottom: 5px">
			<div class="card-header" data-background-color="blue">
				<h4 class="title">Transaksi Selesai</h4>
									...
									<div class="row">
										...
										<div class="col-md-5 col-xs-12">
											<div class="form-group">
										    	...
										    	<a href="/transaksi/selesai" class="btn btn-warning"><i class="material-icons">refresh</i></a>
						...
						@if ($transaksis->isEmpty())
							<div class="card-content">
		                        <div class="text-center">
		                            ...
		                            <h4 class="text-muted">Belum ada transaksi selesai </h4>
		                        </div>
	                        </div>
	                    @endif
